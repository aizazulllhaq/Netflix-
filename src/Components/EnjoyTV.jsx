    ...
    <section className="w-[100%] border-t-[2px] border-t-gray-500  bg-black sm:py-[30px] py-[50px]">
      <div className="max-w-[1170px] mx-auto grid sm:grid-cols-2 grid-cols-1 items-center pb-[80px]">
        <div className="left text-white px-[50px]">
          <h1 className="sm:text-5xl font-bold text-3xl">Enjoy on your TV</h1>
        ...
        <div className="right relative">
          ...
          <div className="">
            <img src="https://assets.nflxext.com/ffe/siteui/acquisition/ourStory/fuji/desktop/tv.png" className="relative z-[2]" alt="" />
            <video className="absolute z-[1] top-[22%] w-[70%] left-[15%]" autoPlay muted>
